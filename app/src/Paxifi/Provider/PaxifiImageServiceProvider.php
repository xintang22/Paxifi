...
use Paxifi\Support\Image\ImageManager;

class PaxifiImageServiceProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        $app->bindShared('paxifi.image', function ($app) {
